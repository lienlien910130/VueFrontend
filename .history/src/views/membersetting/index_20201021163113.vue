                    ...
                    <div class="chart-wrapper">
                        <el-card class="box-card">
                            ...
                            <div v-for="(item,index) in option" :key="index" class="text item">
                                {{ index+1 }}.
                                {{ item.label }}
                                <div v-if="type == 'edit' && current == item.id" style="float: right;">
                                    <i class="el-icon-circle-check" @click="onEdit(item.id)"></i>
                                </div>
                                <div v-else style="float: right;">
                                    <i class="el-icon-edit" @click="changeEdit(item.id)"></i>
                                    <i class="el-icon-delete" @click="checkDelete(item.id)"></i>
                                </div>
                            </div>
                        </el-card>
                    </div>
