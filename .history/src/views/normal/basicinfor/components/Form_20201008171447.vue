<template>
  <div class="app-container">
    <el-form class="buildinginfo" ref="form" :model="form" :rules="formRules" label-width="100px">
      ...
      <el-form-item label="檢視文件">
        <div class="files">
         ...
         <span>
           <i class="el-icon-delete" style="float:right;" @click="delbufile(item.id)" />
         </span>
          </div>
        </div>
...
<script>
import { editbuInfo,uploadbuildinginfo,getbufiles,downloadbufile,delbufile  } from '@/api/building'
