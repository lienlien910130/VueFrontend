    ...
    <el-form class="buildinginfo" ref="form" :model="form" :rules="formRules" label-width="120px">
      ...
      <el-form-item label="檢視文件">
        ...
        <el-upload
          ...
          <el-button style="margin-left: 10px;" size="small" type="success" @click="upload">上傳</el-button>
        </el-upload>
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  methods: {
    uploadURL: function() {
        return "http://192.168.88.65:59119/basic/"+this.id+"/buildings/"+this.buildingid+"/fileUpload";
    },
    openuser(id){
