  ...
  methods: {
    ...
    handleBlockOption(index, content) {
      ...
      if (index === 'update'){
        ...
        getinspectionfiles(content).then( respone => {
          console.log('getinspectionfiles=>'+JSON.stringify(respone))
    ...
    getinspectionfiles(content){
      getinspectionfiles(content).then( respone => {
        console.log('getinspectionfiles=>'+respone)
      }).catch(error=> {
          console.log('error=>'+error)
      })
    }
