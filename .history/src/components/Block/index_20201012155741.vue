            ...
            >
                ...
                style="margin-left:50px;">
                    <el-form-item 
                        ...
                        :prop="item.prop"
                        :label="item.label"
                        v-show="item.format !== 'hide' || item.format !== 'hide-f' || item.format !== 'hidel'"
                        :rules="[
                    ...
                    <span v-else-if="item.format == 'hide' "></span>
                    ...
                    <Upload 
                    v-else-if="item.format == 'file' && dialogStatus == 'update'"
                    v-on="uploadEvent"></Upload>
