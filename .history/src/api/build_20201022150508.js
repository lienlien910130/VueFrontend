...
const building = {
    ...
    apiPostContactUnitOption(){ return req('get','/basic/'+bid+'/options/cuos') },
    apiPatchContactUnitOption(){ return req('get','/basic/'+bid+'/options/cuos') },
    apiDeleteContactUnitOption(){ return req('get','/basic/'+bid+'/options/cuos') },
}
