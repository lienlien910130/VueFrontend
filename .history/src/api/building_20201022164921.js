...
//上傳門牌檔案
// export function uploadusageofFloor(usageOfFloorsId,userId,data) {
//   return request({
//     url: '/basic/'+userId+'/usageOfFloors/'+usageOfFloorsId+'/fileUpload',
//     method: 'post',
//     headers: {'Content-Type': 'multipart/form-data'},
//     data
//   })
// }
//取得門牌檔案
// export function getusageofFloorfiles(usageOfFloorsId) {
//   return request({
//     url: '/basic/usageOfFloors/'+usageOfFloorsId+'/filesList',
//     method: 'get'
//   })
// }
//下載門牌檔案
// export function downloadusageofFloorfile(filesId) {
//   return request({
//     url: '/report/fileDownload/'+filesId,
//     method: 'get'
//   })
// }
//刪除門牌檔案
// export function delusageofFloorfile(filesId) {
//   return request({
//     url: '/report/fileDelete/'+filesId,
//     method: 'delete'
//   })
