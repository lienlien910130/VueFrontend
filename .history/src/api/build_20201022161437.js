...
const building = {
    ...
    //門牌資料
    apiGetBuildingOfHouses(floorId){ return req('get','basic/buildingId/'+bid+'/floors/a/usage-of-floors') },
    apiGetFloorOfHouse(floorId){ return req('get','basic/floors/'+floorId+'/usage-of-floors') },
    apiPostFloors(floorId,data){ return req('post','basic/floors/'+floorId+'/usage-of-floors',data) },
    apiPatchFloors(data){ return req('patch','/basic/usage-of-floors',data) },
    apiDeleteFloors(floorofhouseId){ return req('delete','/basic/'+floorofhouseId+'/usage-of-floors') },
