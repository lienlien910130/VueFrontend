<template>
    ...
    >
        ...
        <div class="ef-node-right-ico">
            ...
            <i class="el-icon-circle-check el-node-state-success" v-show="node.state === 1"></i> 
            <i class="el-icon-loading el-node-state-running" v-show="node.state === 2"></i>
            <i class="el-icon-warning-outline el-node-state-warning" v-show="node.state === 3"></i>
            <i class="el-icon-warning-outline el-node-state-warning" v-show="node.state === 4"></i>
            <i class="el-icon-circle-close el-node-state-error" v-show="node.state === 5"></i>
            <i class="el-icon-refresh el-node-state-running" v-show="node.state === 20"></i>
