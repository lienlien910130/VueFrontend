...
const report = {
    ...
    apiGetInspectionSearchPages(data){ return req('post','/reportInspection/'+this.getBid()+'/ss',data)  },
    ...
    apiGetPublicSafeSearchPages(data){ return req('post','/reportPublicSafe/'+this.getBid()+'/ss',data)  },
