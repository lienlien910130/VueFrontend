...
const report = {
    ...
    apiGetInspectionSearchPages(data){ return req('post','/index/reportInspection/'+this.getBid()+'/ss',data,true)  },
    ...
    apiGetPublicSafeSearchPages(data){ return req('post','/index/reportPublicSafe/'+this.getBid()+'/ss',data,true)  },
