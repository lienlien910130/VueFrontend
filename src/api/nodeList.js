...
const nodeList = {
    ...
    apiPatchNode(data){ return req('patch','/selfDefenseFireMarshalling/CNodeMgmt/s',null,data) },
    ...
    apiPatchOption(data){ return req('patch','/selfDefenseFireMarshalling/COptionMgmt/s',null,data) },
