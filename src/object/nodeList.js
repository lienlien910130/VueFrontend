  ...
  constructor(data) {
    ...
    var accounts =
      linkAccountList !== undefined
        ...
        : [];
    var options =
      linkCOptions !== undefined
        ? linkCOptions.map((item) => {
            return new COption(item);
          })
        : [];
    this.name = name;
    this.nodeId = nodeId;
