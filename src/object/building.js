...
class Building extends Parent {
    ...
    static getTableConfig(){
        return [
            ...
            isAssociate:false,isEdit:true,isUpload:true,isExport:true,isBlock:true,formType:'address'},
            { label:'面積' , prop:'area',
            mandatory:true, message:'請輸入面積',format:'inputAppend',
            ...
            mandatory:true, message:'請輸入高度',format:'inputAppend',
            pattern:/^\d+$|^\d+[.]?\d+$/,errorMsg:'請輸入正確格式',isPattern:true,
            isHidden:false,isSearch:false,placeholder:'請輸入高度',
            isAssociate:false,isEdit:true,isUpload:true,isExport:true,isBlock:false,formType:'inputNumber'},
            { label:'地上樓層' , prop:'floorsOfAboveGround',format:'inputPrepend',
            ...
            { label:'地下樓層' , prop:'floorsOfUnderground',format:'inputPrepend',
    ...
    static getUpdateConfig(){
        return [
            ...
            pattern:/^[0-9]{1,4}$/,errorMsg:'請輸入0~9999',isPattern:true,
            isHidden:false,isSearch:false,placeholder:'請輸入地上樓層，無則輸入0',
            isAssociate:false,isEdit:false,isUpload:true,isExport:true,isBlock:true,formType:'inputNumber'},
            { label:'地下樓層' , prop:'floorsOfUnderground',format:'inputPrepend',
            mandatory:true, message:'請輸入地下樓層，無則輸入0',
            pattern:/^[0-9]{1,4}$/,errorMsg:'請輸入0~9999',isPattern:true,
            isHidden:false,isSearch:false,placeholder:'請輸入地下樓層，無則輸入0',
